...
test_parsed_request.set_status_code(t_status_code)
...
assert t_set_status_code: 	test_parsed_request.get_status_code == t_status_code
assert t_set_field: 	test_parsed_request.get_header("Host") == t_field_value
