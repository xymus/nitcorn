...
connexion keep-alive\cite{http1.0}.
    ...
    \item[x86_64] Architecture de processeur 64 bits développée par AMD, mais compatible avec la famille de processeur 64 bit d'Intel (à l'exception de Itanium).
...
\subsection{Administrateur système:} Le sysadmin est la personne qui s'occupe de la configuration et de la maintenance du serveur et du système sur lequel est installé le serveur. C'est la personne possédant le plus de droit sur le serveur.
\subsection{Administrateur:} Un adminisrateur est la personne qui s'occupe de la configuration et de la maintenant d'une des applications installées sur le serveur.
