...
Afin de recevoir des requêtes, je dois écouter un port à l'aide d'un socket. Je veux écouter plusieurs ports en même temps afin de supporter plusieurs virtual host. Je transfère la requête au module de traitement sous forme de texte.
