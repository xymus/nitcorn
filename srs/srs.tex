...
Une fois ce traitement fait, je dois retourner (@TODO à voir avec spec de l'interface DONE BUT WAIT FOR PUSH)
une réponse HttpResponse en l'écrivant avec write(). Cette réponse doit
