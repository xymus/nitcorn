...
extern const classtable_elt_t VFT_event___Reactor[];
...
extern const classtable_elt_t VFT_event___HttpReactor[];
...
#define ID_event___Reactor (SFT_event[3])
#define COLOR_event___Reactor (SFT_event[4])
#define INIT_TABLE_POS_event___Reactor (SFT_event[5] + 0)
#define CALL_event___Reactor___read(recv) ((event___Reactor___read_t)CALL((recv), (SFT_event[5] + 1)))
#define CALL_event___Reactor___init(recv) ((event___Reactor___init_t)CALL((recv), (SFT_event[5] + 2)))
...
#define CALL_event___ConnectionListener___error_callback(recv) ((event___ConnectionListener___error_callback_t)CALL((recv), (SFT_event[8] + 4)))
#define CALL_event___ConnectionListener___exit_loop(recv) ((event___ConnectionListener___exit_loop_t)CALL((recv), (SFT_event[8] + 5)))
#define ID_event___HttpReactor (SFT_event[9])
#define COLOR_event___HttpReactor (SFT_event[10])
#define INIT_TABLE_POS_event___HttpReactor (SFT_event[11] + 0)
#define CALL_event___String___destroy(recv) ((event___String___destroy_t)CALL((recv), (SFT_event[12] + 0)))
...
typedef void (*event___Reactor___read_t)(val_t p0, val_t p1);
void event___Reactor___init(val_t p0, int* init_table);
typedef void (*event___Reactor___init_t)(val_t p0, int* init_table);
val_t NEW_Reactor_event___Reactor___init();
void event___ConnectionListener___bind_to(val_t p0, val_t p1, val_t p2, val_t p3, val_t p4, int* init_table);
typedef void (*event___ConnectionListener___bind_to_t)(val_t p0, val_t p1, val_t p2, val_t p3, val_t p4, int* init_table);
val_t NEW_ConnectionListener_event___ConnectionListener___bind_to(val_t p0, val_t p1, val_t p2, val_t p3);
...
typedef void (*event___ConnectionListener___read_callback_t)(val_t p0, val_t p1, val_t p2);
...
typedef void (*event___HttpReactor___read_t)(val_t p0, val_t p1);
val_t NEW_HttpReactor_event___Reactor___init();
void event___String___destroy(val_t p0);
typedef void (*event___String___destroy_t)(val_t p0);
