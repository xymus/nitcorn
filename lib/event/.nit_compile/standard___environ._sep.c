...
val_t standard___environ___String___environ(val_t p0){
  ...
  fra.me.REG[0] = p0;
  /* /home/jp/Projects-ssd/nit/lib/standard/environ.nit:26 */
  ...
  /* /home/jp/Projects-ssd/nit/lib/standard/environ.nit:28 */
  if (!once_value_1) {
    if (!once_value_2) {
  ...
  fra.me.REG[1] = fra.me.REG[1];
  /* /home/jp/Projects-ssd/nit/lib/standard/environ.nit:29 */
  ...
  if (UNTAG_Bool(REGB0)) {
    /* /home/jp/Projects-ssd/nit/lib/standard/environ.nit:30 */
    fra.me.REG[0] = NEW_String_standard___string___String___from_cstring(fra.me.REG[0]);
    goto label3;
  } else {
    /* /home/jp/Projects-ssd/nit/lib/standard/environ.nit:32 */
    if (!once_value_4) {
      fra.me.REG[1] = BOX_NativeString("");
      REGB0 = TAG_Int(0);
      fra.me.REG[1] = NEW_String_standard___string___String___with_native(fra.me.REG[1], REGB0);
...
val_t standard___environ___NativeString___get_environ(val_t p0){
  ...
  fra.me.REG[0] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* /home/jp/Projects-ssd/nit/lib/standard/environ.nit:38 */
