/* This C file is generated by NIT to compile program event. */
...
const classtable_elt_t VFT_event___EventBase[50] = {
  ...
  {(bigint) 1 /* 17: EventBase < Object: superclass init_table position */},
  ...
  {(bigint) 0 /* 46: EventBase < Pointer: superclass init_table position */},
...
void CHECKNEW_standard___collection___abstract_collection___ContainerIterator(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_is_ok", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___collection___abstract_collection___ContainerIterator____container(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "_container", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___collection___abstract_collection___MapKeysIterator(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "@iterator", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___collection___abstract_collection___CoupleMapIterator(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_iter", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___collection___range___IteratorRange(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_range", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___collection___range___IteratorRange____item(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "_item", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___collection___list___ListIterator(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_list", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___collection___list___ListIterator____index(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "_index", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___collection___array___Array(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_capacity", LOCATE_event, 0);
  }
...
void CHECKNEW_standard___collection___array___ArrayIterator(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_array", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___collection___array___ArrayMap(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "@keys", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___collection___array___ArrayMap_____atvalues(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "@values", LOCATE_event, 0);
  }
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_last_index", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___collection___array___ArrayMapKeys(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "@map", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___collection___hash_collection___HashMapNode(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_key", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___collection___hash_collection___HashMapIterator(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_map", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___collection___hash_collection___HashSetIterator(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_set", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___stream___FDIStream(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "@eof", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___stream___FDStream_____atfd(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "@fd", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___stream___FDOStream(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "@is_writable", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___stream___FDStream_____atfd(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
...
void CHECKNEW_standard___string_search___BM_Pattern(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_motif", LOCATE_event, 0);
  }
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_gs", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___string_search___BM_Pattern____bc_table(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "_bc_table", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___string_search___Match(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_string", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___string_search___Match____from(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "_from", LOCATE_event, 0);
  }
...
void CHECKNEW_standard___file___IFStream(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_end_reached", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "_buffer_pos", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___file___OFStream(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_writable", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___exec___Process(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "@data", LOCATE_event, 0);
  }
  stack_frame_head = fra.me.prev;
}
...
void CHECKNEW_standard___exec___IProcess(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "@stream_in", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___exec___Process_____atdata(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
...
void CHECKNEW_standard___exec___OProcess(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "@stream_out", LOCATE_event, 0);
  }
  REGB0 = TAG_Bool(ATTR_standard___exec___Process_____atdata(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
